...
* [Главная страница](diplom/templates/index.html).
* [Страница раздела](diplom/templates/smartphones.html).
* [Страница незаполненного раздела](diplom/templates/empty_section.html).
* [Страница товара](diplom/templates/phone.html).
...
* Реализовать механизм анонимных отзывов как показано на макете [Страница товара](diplom/templates/phone.html).
